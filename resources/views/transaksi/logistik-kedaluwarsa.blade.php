...
@section('body')
    <div class="h1 fw-bold">Logistik Kedaluwarsa</div>
    <div class="container-fluid rounded p-3 bg-white mb-3">
        <form action="/transaksi/logistik-kedaluwarsa/sort">
        ...
        <form action="/transaksi/logistik-kedaluwarsa/reset" method="post">
            @csrf
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="exampleModalLabel">Tambah Logistik Kedaluwarsa</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="/transaksi/logistik-kedaluwarsa" method="post" id="show">
                        @csrf
                        <div class="row mb-3">
                            <div class="col">
                                            ...
                                            <tr class="table-danger">
                                                <td>
                                                    <input class="form-check-input" type="checkbox" id="flexCheckDefault"
                                                        name="inboundLogistic_id[]" value="{{ $inboundLogistic->id }}">
                                                </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center">
                                <form action="/transaksi/logistik-kedaluwarsa/{{ $outboundLogistic->id }}" method="post"
                                    class="d-inline"
